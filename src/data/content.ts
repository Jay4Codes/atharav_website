...
export const skills = [
  {
    ...
    items: [
      ...
      { label: "Data visualization", icon: "chart" },
    ],
  },
  {
    ...
    icon: "chevrons",
    items: [
      { label: "Software design", icon: "layers" },
      { label: "Computer programming", icon: "chevrons" },
      { label: "Unity", icon: "cube" },
      { label: "Product development", icon: "spark" },
      { label: "Requirements analysis", icon: "checklist" },
      { label: "ERP systems", icon: "grid" },
    ],
  },
  {
    group: "Leadership",
  ...
  },
  {
    ...
    icon: "ball",
    items: [
      { label: "Badminton", icon: "shuttle" },
      { label: "Squash", icon: "racquet" },
